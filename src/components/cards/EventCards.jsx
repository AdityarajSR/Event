      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-16 lg:gap-6">
        <div className="shadow-slate-300 shadow-md rounded-md">
          ...
          <p className="p-5 text-lg text-gray-600">
            Manage and organize events on our platform that specializes in meticulously planning
            and ensuring a seamless and unforgettable experience for college
            events and their event attendees.
          </p>
        </div>
        <div className="shadow-slate-300 shadow-md rounded-md">
          <div

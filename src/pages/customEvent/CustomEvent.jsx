                                    ...
                                    <div className="sm:col-span-3">
                                        ...
                                        <div className="mt-2">
                                            <select onChange={handleEventType} className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' name="type" id="">
                                                ...
                                                <option value="Wedding">College Fest</option>
                                                <option value="Birthday">Hackathon</option>
                                                <option value="Anniversary">Cultural Event</option>
                                                <option value="Arts and Culture Festival">Seminar/Webinar</option>
                                                <option value="Corporate Event">Sports Event</option>
                                            </select>
                                        </div>
                                    </div>
